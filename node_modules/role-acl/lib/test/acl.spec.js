...
describe('Test Suite: Access Control', function () {
    ...
    var categoryCustomContextAllowed = { loginUserId: '1', resourceProfileId: '1' };
    var categoryCustomContextNotAllowed = { loginUserId: '1', resourceProfileId: '2' };
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _a = expect;
                        return [4 /*yield*/, acUsingObj.can('sports/custom').context(categoryCustomContextAllowed)
                                .execute('create').on('profile')];
                    case 1:
                        _a.apply(void 0, [(_e.sent()).granted]).toEqual(true);
                        _b = expect;
                        return [4 /*yield*/, acUsingObj.can('sports/custom').context(categoryCustomContextNotAllowed)
                                .execute('edit').on('profile')];
                    case 2:
                        _b.apply(void 0, [(_e.sent()).granted]).toEqual(false);
                        acUsingArray = new AccessControl(conditionalGrantArrayWithCustomAsyncFunction);
                        _c = expect;
                        return [4 /*yield*/, acUsingArray.can('sports/custom').context(categoryCustomContextAllowed)
                                .execute('create').on('profile')];
                    case 3:
                        _c.apply(void 0, [(_e.sent()).granted]).toEqual(true);
                        _d = expect;
                        return [4 /*yield*/, acUsingArray.can('sports/custom').context(categoryCustomContextNotAllowed)
                                .execute('edit').on('profile')];
                    case 4:
                        _d.apply(void 0, [(_e.sent()).granted]).toEqual(false);
                        return [2 /*return*/];
